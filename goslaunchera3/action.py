...
def rsyncTaille(self):
    ...
    # @TEMPLATE 
    arguments = ["--partial", "--inplace","--progress","--delete-after", "--bwlimit=0", "--chmod=ugo=rwX","www.clan-gos.fr::@TEMPLATE",self.var_Arma3Path+"/@GOS/@TEMPLATE"]
    ...
    # @ISLANDS
    arguments = ["--partial", "--inplace","--progress","--delete-after", "--bwlimit=0", "--chmod=ugo=rwX","www.clan-gos.fr::@ISLANDS",self.var_Arma3Path+"/@GOS/@ISLANDS"]
    ...
    # @MATERIEL
    arguments = ["--partial", "--inplace","--progress","--delete-after", "--bwlimit=0", "--chmod=ugo=rwX","www.clan-gos.fr::@MATERIEL",self.var_Arma3Path+"/@GOS/@MATERIEL"]
    ...
    # @UNITS
    arguments = ["--partial", "--inplace","--progress","--delete-after", "--bwlimit=0", "--chmod=ugo=rwX","www.clan-gos.fr::@UNITS",self.var_Arma3Path+"/@GOS/@UNITS"]
    ...
    # @FRAMEWORK
    arguments = ["--partial", "--inplace","--progress","--delete-after", "--bwlimit=0", "--chmod=ugo=rwX","www.clan-gos.fr::@FRAMEWORK",self.var_Arma3Path+"/@GOS/@FRAMEWORK"]
    ...
    # @CLIENT
    arguments = ["--partial", "--inplace","--progress","--delete-after", "--bwlimit=0", "--chmod=ugo=rwX","www.clan-gos.fr::@CLIENT",self.var_Arma3Path+"/@GOS/@CLIENT"]
    ...
    # @TEST
    arguments = ["--partial", "--inplace","--progress","--delete-after", "--bwlimit=0", "--chmod=ugo=rwX","www.clan-gos.fr::@TEST",self.var_Arma3Path+"/@GOS/@TEST"]
    ...
    # @INTERCLAN
    arguments = ["--partial", "--inplace","--progress","--delete-after", "--bwlimit=0", "--chmod=ugo=rwX","www.clan-gos.fr::@INTERCLAN",self.var_Arma3Path+"/@GOS/@INTERCLAN"]
    ...
    # @GENERAL
    arguments = ["--partial", "--inplace","--progress","--delete-after", "--bwlimit=0", "--chmod=ugo=rwX","www.clan-gos.fr::@GOS",self.var_Arma3Path+"/@GOS"]
...
def rsyncGos(self, syncname, label_state, progressbar_fichier,progressbar_global, label_debit, pushbutton):
    arguments = ["--partial", "--inplace","--progress","--delete-after", "--bwlimit=0", "--chmod=ugo=rwX","www.clan-gos.fr::"+syncname,self.var_Arma3Path+"/@GOS/"+syncname]
